...
for i in entityname:
  ...
  for t in range(6, -1, -1):
      ...
      week0 = entity1.iloc[len(entity1)-48*(14+t):len(entity1)-48*(t+7), col_num:col_num+final_step]
      ...
      naive.columns = name
      naive.to_excel('/content/drive/MyDrive/BE/BE_'+str(energy_type)+'_New/naive/7daysprediction/'+str(save_names)+'/naive_predictions/'+str(i)+' prediction at '+str(6-t)+'day.xlsx')
  ...
  mae.to_excel('/content/drive/MyDrive/BE/BE_'+str(energy_type)+'_New/naive/7daysprediction/'+str(save_names)+'/naive_error/'+str(i)+'.xlsx')
  print(i)
  g+=1
  tot_pred +=1
...
tot_error.to_excel('/content/drive/MyDrive/BE/BE_'+str(energy_type)+'_New/naive/7daysprediction/'+str(save_names)+'/quantity 1weekback.xlsx')
